...
public class ISO7816Response {
    ...
    public static String getResponseString(int sw1, int sw2){
        if(sw1 == 0x90 && sw2 == 0x00)
            ...
            return "Response bytes still available: " + (int)sw2 + " bytes";
        
        else if(sw1 == 0x62 && sw2 == 81)
            return "Non-volatile memory unchanged (Part of returned data may be corrupted)";
        else if(sw1 == 0x62 && sw2 == 82)
            return "Non-volatile memory unchanged (End of file/record reached before reading Le bytes)";
        else if(sw1 == 0x62 && sw2 == 83)
            return "Non-volatile memory unchanged (Selected file invalidated )";
        else if(sw1 == 0x62 && sw2 == 84)
            return "Non-volatile memory unchanged (FCI not formatted)";
        else if(sw1 == 0x62)
            ...
            return "Command not allowed ("+sw2+")";
            ...
            return "Wrong length (Correct length: " + (int) sw2+")";
            ...
            return "Unkown response (SW1: " + Integer.toString(sw1, 16)+" SW2:"+ Integer.toString(sw2, 16)+")";
    }
}
